...
public class PrefabRegistryViewEditor : ISettingView
{
    ...
    public PrefabRegistryViewEditor(EntangleEditorWindow entangleEditor)
    {
    ...
    public void DisplayView()
    {
        ...
        ParentView.prefabRegistry.MyPlayer = (EntangleView)EditorGUILayout.ObjectField("My player", ParentView.prefabRegistry.MyPlayer, typeof(EntangleView), false, GUILayout.ExpandWidth(true));
        GUILayout.EndHorizontal();
        GUILayout.BeginHorizontal("box");
        ParentView.prefabRegistry.RemotePlayer = (EntangleView)EditorGUILayout.ObjectField("Remote player", ParentView.prefabRegistry.RemotePlayer, typeof(EntangleView), false, GUILayout.ExpandWidth(true));
        GUILayout.EndHorizontal();
        GUILayout.Space(6);
        GUILayout.BeginHorizontal("box");
    ...
    private void DisplayEntities()
    {
        ...
        for (int i = 0; i < entities.Count; i++)
        {
            ...
            entities[i] = (EntangleView)EditorGUILayout.ObjectField("", entities[i], typeof(EntangleView), false, GUILayout.ExpandWidth(true));
    ...
    private void DisplayEntity(EntangleView entangleView, int index)
    {
        GUILayout.BeginHorizontal("box");
        GUILayout.Label(index.ToString(), GUILayout.Width(50));
        entangleView = (EntangleView)EditorGUILayout.ObjectField("", entangleView, typeof(EntangleView), false, GUILayout.ExpandWidth(true));
