...
public class ConfigViewEditor : ISettingView
{
    ...
    public ConfigViewEditor(EntangleEditorWindow entangleEditor)
    {
    ...
    public void DisplayView()
    {
        ...
        ParentView.Transport = (EntangleEditorWindow.TransportLayer)EditorGUILayout.EnumPopup(ParentView.Transport, GUILayout.ExpandWidth(true));
